#!/bin/sh 
DEMO="Cloud JBoss BPM Vacation Request Demo"
AUTHORS="Kent Hua, Eric D. Schabell"
PROJECT="git@github.com:redhatdemocentral/rhcs-vacation-request-demo.git"
SRC_DIR=./installs
...
echo
oc start-build rhcs-vacation-demo --from-dir=. --follow=true --wait=true
...
echo "=================================================================================="
echo "=                                                                                ="
echo "=  Login to start exploring the Vacation Request project:                        ="
echo "=                                                                                ="
